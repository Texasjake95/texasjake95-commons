...
import com.texasjake95.commons.asm.IClassTransformer;
...
public class EventTransformer implements IClassTransformer {
	...
	{
		if (bytes == null || name.equals("com.texasjake95.commons.event.Event") || name.indexOf('.') == -1)
		{
			return bytes;
		}
	...
	private boolean buildEvents(ClassNode classNode) throws Exception
	{
		...
		Class<?> listenerListClazz = Class.forName("com.texasjake95.commons.event.ListenerList", false, getClass().getClassLoader());
