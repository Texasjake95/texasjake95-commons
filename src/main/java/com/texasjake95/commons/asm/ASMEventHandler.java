...
import com.texasjake95.commons.event.Event;
import com.texasjake95.commons.event.EventPriority;
import com.texasjake95.commons.event.IEventListener;
import com.texasjake95.commons.event.SubscribeEvent;
...
public class ASMEventHandler implements IEventListener {
	...
	public Class<?> createWrapper(Method callback)
	{
		 ...
		 * System.out.println("Callback: " + callback.getName() +
		 * Type.getMethodDescriptor(callback)); System.out.println("Event:    "
		 * + eventType);
		 */
